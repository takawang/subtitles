(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global =
      ...
      (global.YoutubeExternalSubtitle = factory()));
})(this, function () {
  'use strict';
  ...
  ***************************************************************************** */
  ...
  var getSubtitles = function (container) {
    ...
    return initService.getSubtitles().filter(function (subtitle) {
      return subtitle.isInContainer(container);
    });
  };
  ...
  var fullscreenChangeHandler = function () {
    ...
    for (var _i = 0, subtitles_1 = subtitles; _i < subtitles_1.length; _i++) {
      ...
      subtitle.setIsFullscreenActive(
        isFullscreen ? fullscreenSubtitle === subtitle : null,
      );
    }
  };
  ...
  var addGlobalStyles = function (document) {
    ...
    style.innerHTML =
      '\n    .' +
      CSS.CLASS +
      " { position: absolute; display: none; z-index: 0; pointer-events: none; color: #fff; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-weight: normal; font-size: 17px; text-align: center; }\n    ." +
      CSS.CLASS +
      ' span { background: #000; background: rgba(0, 0, 0, 0.9); padding: 1px 4px; display: inline-block; margin-bottom: 2px; }\n    .' +
      CSS.CLASS +
      '.' +
      CSS.FULLSCREEN_IGNORE +
  ...
  var buildCache = function (subtitles) {
    ...
    for (var _i = 0, subtitles_1 = subtitles; _i < subtitles_1.length; _i++) {
      var subtitle = subtitles_1[_i];
      for (
        var _a = 0, _b = getCacheNames(subtitle.start, subtitle.end);
        _a < _b.length;
        _a++
      ) {
        var cacheName = _b[_a];
  ...
  var renderSubtitle = function (
    ...
    if (player) {
      ...
      element.style.top =
        ...
        'px';
      element.style.left =
        frame.x + (frame.width - element.offsetWidth) / 2 + 'px';
  ...
  var Subtitle = /** @class */ (function () {
    function Subtitle(iframe, subtitles, renderMethod) {
      ...
      this.onTimeChange = function () {
        var subtitle = getSubtitleFromCache(
          _this.player.getCurrentTime(),
          _this.cache,
        );
      ...
      if (iframe.youtubeExternalSubtitle) {
        throw new Error(
          'YoutubeExternalSubtitle: subtitle is already added for this element',
        );
      }
